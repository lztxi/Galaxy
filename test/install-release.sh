...
get_latest_version() {
  ...
  do
    ...
    grep -q "https://gitee.com/passerby-b/javascript/raw/master/test/Xray-linux-64.zip" "$tmp_file" && break
  done
  "rm" "$tmp_file"
...
download_xray() {
  DOWNLOAD_LINK="https://gitee.com/passerby-b/javascript/raw/master/test/Xray-linux-64.zip"
